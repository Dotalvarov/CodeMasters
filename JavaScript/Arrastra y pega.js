...
function soltado(e) {
    ...
    var descripciones = {
        "1": "El símbolo de terminación marca el punto inicial o final del sistema. Por lo general, contiene la palabra Inicio o Fin",
        "2": "Un rectangulo solo puede representar un solo paso dentro de un proceso (agregar dos tazas de harina), o un subproceso completo (hacer pan) dentro de un proceso más grande.",
        "3": "Un documento o informe impreso.",
        "4": "Un punto de decisión o ramificación. Las líneas que representan diferentes decisiones surgen de diferentes puntos del diamante.",
        "5": "Representa el material o la información que entra o sale del sistema, como una orden del cliente (entrada) o un producto (salida)."
    };
            ...
            didClose: () => {
                if (rBuenas == 5) {
                    ...
                    Swal.fire({
                        ...
                        showConfirmButton: false,
                        didClose: () => {
                            window.open("Nivel_2.1.html", "_self");
                        }
                    });
                }
            }
